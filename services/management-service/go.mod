module jusha/gantt/service/management
...
replace (
	...
	jusha/mcp/pkg => ../../pkg
// jusha/mcp/pkg => 192.168.20.3/dsd-department/pds/common-component/mcp/go/pkg.git v0.0.1-dev.20251112
)
...
require (
	...
	jusha/mcp/pkg v0.0.1-dev.20251112
)
