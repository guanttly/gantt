module jusha/agent/rostering

go 1.23.2

// replace jusha/mcp/pkg => 192.168.20.3/dsd-department/pds/common-component/mcp/go/pkg.git v0.0.1-dev.20251112
replace (
...
require (
	...
	jusha/agent/sdk/context v0.0.0-00010101000000-000000000000
	jusha/agent/sdk/rostering v0.0.0-00010101000000-000000000000
